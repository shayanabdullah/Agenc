        ...
        <>
            <section className="py-[150px] bg-white" id='service'>   
                <div className="container">
                    <div className="header w-full text-center pb-14 px-2">
                    ...
                    <div className="services grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6">
                        <div className="service-items normal-2:px-[49px] pt-20 pb-[47px] rounded-[20px] border-2 border-transparent hover:border-black/25 hover:shadow-xl duration-300 px-2">
                            <div className="item-body text-center">
                                <div className="img w-full flex justify-center">
                                    <img src={web} alt="" />
                                </div>
                                <div className="text-box text-center">
                                    <h3 className='font-inter font-bold md:text-[25px] text-3xl text-[#151515] pt-10'>Web Design</h3>
